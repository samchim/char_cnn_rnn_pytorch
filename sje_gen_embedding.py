...
def main(args):
    ...
    net_txt.load_state_dict(torch.load(args.model_path, map_location=device), False)
    ...
    print("cls_feats_txt")
    print(type(cls_feats_txt))
    print(cls_feats_txt.shape)
    print("cls_feats_txt[0]")
    print(type(cls_feats_txt[0]))
    print(cls_feats_txt[0].shape)
    # print('----- RETRIEVAL -----')
